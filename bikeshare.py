...
def get_filters():
    """
    Asks user to specify a city, month, and day to analyze the data files.
...
def load_data(city, month, day):
    """
    Loads data for the specified city and filters by month and day if applicable from the data files.
